...
public class MainController {
    ...
    public String addEmployee(@ModelAttribute Employee employee, @RequestParam("photoFile") MultipartFile file) throws IOException {
        // Если файл не пустой, сохраняем его как строку Base64
        if (!file.isEmpty()) {
            String base64Photo = convertToBase64(file);
            employee.setPhoto(base64Photo); // Сохраняем строку Base64 в объекте Employee
        }
    ...
    private String convertToBase64(MultipartFile file) throws IOException {
        ...
        return Base64.encodeBase64String(imageBytes); // Кодирование в строку Base64
    }
